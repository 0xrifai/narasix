...
<header class="<?php echo esc_attr( $header_class ); ?>">
		<?php 
			if ( is_home() && ( $section_heading !== '' ) ) { 
				echo '<div class="px-4 text-center category text-charcoal-700 dark:text-charcoal-200 bg-charcoal-100 dark:bg-charcoal-700/70 space-y-1 rounded-lg py-4 backdrop-blur">';
				echo '<h2 class="font-semibold uppercase">';
			...
			if ( is_archive() ) {
				...
				if ( is_tag() ) {
					...
					echo '<div class="px-4 text-center tag text-charcoal-700 dark:text-charcoal-200 bg-charcoal-100 dark:bg-charcoal-700/70 space-y-1 rounded-lg py-4 backdrop-blur">';
			...
			if ( is_page() ) {
				echo '<div class="px-4 text-center page text-charcoal-700 dark:text-charcoal-200 bg-charcoal-100 dark:bg-charcoal-700/70 space-y-1 rounded-lg py-4 backdrop-blur">';
			...
			if ( is_search() ) {
				...
				echo '<div class="px-4 text-center search text-charcoal-700 dark:text-charcoal-200 bg-charcoal-100 dark:bg-charcoal-700/70  mb-6 space-y-1 rounded-lg py-4 backdrop-blur">';
