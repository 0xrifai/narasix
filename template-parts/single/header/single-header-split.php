...
?>
<header class="post-meta <?php echo esc_attr( $header_class ); ?> mx-auto">
		<div class="grid grid-cols-1 items-center gap-4 md:gap-5 lg:grid-cols-2">
			<div class="relative split flex items-center overflow-hidden lg:order-last">
				<?php
				if ( $post_audio ) {
					?>
						<?php
					...
					?>
						<div class="gallery-slpit overflow-x-hidden">
					...
					?>
						<div class="images-split relative js-nsix-lightbox-gallery" itemscope itemtype="http://schema.org/ImageGallery">
									<?php
			...
			<div class="relative px-4 space-y-3 lg:px-0">
				<?php
				...
				?>
					<div class="text-limit opacity-50 text-base mt-2 font-serif tracking-wide">
						<?php the_excerpt(); ?>
					</div>
				<?php
				}
