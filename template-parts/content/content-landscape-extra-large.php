...
( isset( $excerpt_length ) ) || $excerpt_length = 60;
...
<div <?php post_class( $post_class ); ?>>
  <div class="relative block basis-24 md:basis-80 lg:basis-[30rem]">
    <?php
      narasix_featured_img( array(
        'size' => $thumb_size,
        'icon' => $post_format_icon,
        'lazyload' => $lazyload,
        'class' => 'aspect-autos h-full lg:h-72 lg:w-[30rem]',
      ) );
    ?>
  </div>

  <div class="flex flex-1 items-center justify-between">
    <div class="md:!pr-0 md:p-6 md:space-y-4 max-md:pt-2">  
      <?php  
      ...
      <?php
        if( get_the_excerpt() && ( $excerpt_length > 0 ) ) {
          ?>
            <p class="descripiton line-clamp-1 xs:line-clamp-2 sm:line-clamp-3 mt-2 leading-relaxed opacity-50">
      ...
      <div class="font-meta secondary mt-1 flex justify-between items-center border-t pt-1 text-sm">
        <?php
